            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.transactions.store') }}" method="POST" class="forms-sample row">
                            @csrf
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="transaction_type" class="js-example-basic-single w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <select name="bank_id" class="js-example-basic-single w-100">
